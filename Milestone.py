...
def player_move(player, key_vec):
    ...
    player.h_0.pos = player.h_0.pos + key_vec 
    player.h_1.pos = player.h_1.pos + key_vec
    player.h_2.pos = player.h_2.pos + key_vec
    player.h_3.pos = player.h_3.pos + key_vec
    player.h_4.pos = player.h_4.pos + key_vec
    player.h_5.pos = player.h_5.pos + key_vec
    player.h_6.pos = player.h_6.pos + key_vec
    player.h_7.pos = player.h_7.pos + key_vec
    player.h_8.pos = player.h_8.pos + key_vec
    player.h_9.pos = player.h_9.pos + key_vec
    player.h_10.pos = player.h_10.pos + key_vec
    player.h_11.pos = player.h_11.pos + key_vec
    player.h_12.pos = player.h_12.pos + key_vec
    player.h_13.pos = player.h_13.pos + key_vec
    player.h_14.pos = player.h_14.pos + key_vec
    player.h_15.pos = player.h_15.pos + key_vec
    player.h_16.pos = player.h_16.pos + key_vec
    player.h_17.pos = player.h_17.pos + key_vec
    player.h_18.pos = player.h_18.pos + key_vec
    player.h_19.pos = player.h_19.pos + key_vec
    player.h_20.pos = player.h_20.pos + key_vec
    player.h_21.pos = player.h_21.pos + key_vec
